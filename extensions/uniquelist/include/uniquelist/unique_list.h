...
#ifndef UNIQUELIST_UNIQUE_LIST_H
#define UNIQUELIST_UNIQUE_LIST_H
 ...
 */
template <typename T, typename Compare = std::less<T>> struct unique_list {
...
private:
   ...
   *
   * This keeps all elements in this unique_list.
...
#endif // UNIQUELIST_UNIQUE_LIST_H
